...
export function HomeHero(): ReactElement {
  ...
  return (
    <section className="pt-2 pb-7 text-center">
      {/* Eyebrow chip */}
      <span
        className="inline-flex items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--surface)] px-3.5 py-1.5 text-[11px] tracking-[0.22em] text-[var(--muted)] uppercase"
      ...
      {/* Tagline */}
      <p className="mx-auto mt-2 max-w-[420px] text-[15px] leading-relaxed text-[var(--muted)]">
